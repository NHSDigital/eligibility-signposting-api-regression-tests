...
set_environment_secret() {
    ...
    gh secret set "${secret_name}" \
        --repo NHSDigital/eligibility-signposting-api-regression-tests \
        --app actions \
        --env "${environment}" \
        --body "${secret_value}"
}
...
set_environment_secret CPT_FHIR_CLIENT_SECRET "${REF_CPT_FHIR_CLIENT_SECRET}" REF
set_environment_secret CPT_FHIR_CLIENT_SECRET "${INTERNAL_DEV_SANDBOX_CPT_FHIR_CLIENT_SECRET}" INTERNAL-DEV-SANDBOX
set_environment_secret CPT_FHIR_CLIENT_SECRET "${INTERNAL_DEV_CPT_FHIR_CLIENT_SECRET}" INTERNAL-DEV
set_environment_secret CPT_FHIR_CLIENT_SECRET "${INT_CPT_FHIR_CLIENT_SECRET}" INT
set_environment_secret CPT_FHIR_CLIENT_SECRET "${INTERNAL_QA_CPT_FHIR_CLIENT_SECRET}" INTERNAL-QA
