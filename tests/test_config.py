...
INT_TEST_CONFIG_PATHS: list[str] = [
    "data/configs/nbsIntegrationTestConfigs/NBS_RSV_Config_April2026_v0.8WIP.json",
    "data/configs/nbsIntegrationTestConfigs/NBS_COVID_Config_Spring2026_v0.5WIP.json",
